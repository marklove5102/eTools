...
## 6. Marked:
    ...
    3. OpenCV SDK x64 version, utilizes CUDA acceleration, so if your machine does not have an NVIDIA video card, it cannot be used; you can only use x86 version;
